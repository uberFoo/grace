...
// {"magic":"","directive":{"Start":{"directive":"comment-orig","tag":"anchor-struct-documentation"}}}
...
impl Anchor {
    ...
    // {"magic":"","directive":{"End":{"directive":"comment-orig"}}}
    // {"magic":"","directive":{"Start":{"directive":"comment-orig","tag":"anchor-struct-impl-nav-backward-assoc-one-to-subtype_anchor"}}}
    /// Navigate to [`SubtypeAnchor`] across R10(1-1)
    // {"magic":"","directive":{"Start":{"directive":"comment-orig","tag":"anchor-struct-impl-nav-backward-cond-to-subtype_anchor"}}}
    ...
    // {"magic":"","directive":{"Start":{"directive":"comment-orig","tag":"anchor-struct-impl-nav-backward-assoc_many-to-subtype_anchor"}}}
    ...
    pub fn subtype_anchor<'a>(&'a self, store: &'a AssociativeDomainStore) -> Vec<&SubtypeAnchor> {
        ...
        let subtype_anchor = store
            ...
            //                 if subtype_anchor.1.anchor_id == self.id {
