...
impl Supertype {
    ...
    pub fn new(obj_id: &Object, store: &mut SarzakDomainStore) -> Supertype {
    ...
    pub fn r14_object<'a>(&'a self, store: &'a SarzakDomainStore) -> Vec<&Object> {
    ...
    pub fn r13_isa<'a>(&'a self, store: &'a SarzakDomainStore) -> Vec<&Isa> {
        vec![
            store
                .iter_isa()
