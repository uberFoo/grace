...
impl Referent {
    ...
    pub fn new(name: String, store: &mut OneToOneTsStore) -> Referent {
        let id = Uuid::new_v4();
    ...
    pub fn r1c_a<'a>(&'a self, store: &'a OneToOneTsStore) -> Vec<&A> {
    ...
    pub fn r2_b<'a>(&'a self, store: &'a OneToOneTsStore) -> Vec<&B> {
    ...
    pub fn r3c_c<'a>(&'a self, store: &'a OneToOneTsStore) -> Vec<&C> {
