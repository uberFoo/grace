...
use crate::domain::imported_object_ts::UUID_NS;
use crate::domain::isa::types::simple_supertype::SimpleSupertype;
use crate::domain::sarzak::types::object::Object;
use serde::{Deserialize, Serialize};

use crate::domain::imported_object_ts::store::ObjectStore as ImportedObjectTsStore;
...
impl AnotherObject {
    ...
    pub fn new(
        ...
        store: &mut ImportedObjectTsStore,
    ) -> AnotherObject {
