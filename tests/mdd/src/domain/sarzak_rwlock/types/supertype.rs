...
impl Supertype {
    ...
    pub fn r14_object<'a>(&'a self, store: &'a SarzakRwlockStore) -> Vec<Arc<RwLock<Object>>> {
        span!("r14_object");
    ...
    pub fn r13_isa<'a>(&'a self, store: &'a SarzakRwlockStore) -> Vec<Arc<RwLock<Isa>>> {
        span!("r13_isa");
        vec![store
            .iter_isa()
