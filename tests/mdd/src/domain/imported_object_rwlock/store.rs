//! domain::imported_object_rwlock Object Store
//!
//! The ObjectStore contains instances of objects in the domain.
//! The instances are stored in a hash map, keyed by the object's UUID.
//! This is used during code generation, and probably not useful elsewhere.
// {"magic":"","directive":{"Start":{"directive":"ignore-orig","tag":"domain::imported_object_rwlock-object-store-file"}}}
//!
//! # Contents:
//!
//! * [`AnotherObject`]
// {"magic":"","directive":{"Start":{"directive":"ignore-orig","tag":"domain::imported_object_rwlock-object-store-definition"}}}
use std::{
    fs,
    io::{self, prelude::*},
    path::Path,
...
use crate::domain::imported_object_rwlock::types::AnotherObject;
...
impl ObjectStore {
    ...
    // {"magic":"","directive":{"Start":{"directive":"ignore-orig","tag":"domain::imported_object_rwlock-object-store-methods"}}}
    ...
    // {"magic":"","directive":{"Start":{"directive":"ignore-orig","tag":"domain::imported_object_rwlock-object-store-persistence"}}}
    /// Persist the store.
    ///
