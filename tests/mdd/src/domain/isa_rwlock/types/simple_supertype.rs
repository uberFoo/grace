...
use crate::domain::isa_rwlock::types::baz::Baz;
use crate::domain::isa_rwlock::types::simple_subtype_a::SimpleSubtypeA;
use crate::domain::isa_rwlock::types::simple_subtype_b::SIMPLE_SUBTYPE_B;
...
impl SimpleSupertype {
    ...
    pub fn new_simple_subtype_a(
        ...
        let id = Uuid::new_v4();
        let new = Arc::new(RwLock::new(SimpleSupertype {
            state: state,
    ...
    pub fn r4_baz<'a>(&'a self, store: &'a IsaRwlockStore) -> Vec<Arc<RwLock<Baz>>> {
        span!("r4_baz");
        vec![store
            .iter_baz()
