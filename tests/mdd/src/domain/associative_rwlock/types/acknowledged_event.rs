...
use crate::domain::associative_rwlock::types::event::Event;
use crate::domain::associative_rwlock::types::state::State;
...
impl AcknowledgedEvent {
    ...
    pub fn r20_event<'a>(&'a self, store: &'a AssociativeRwlockStore) -> Vec<Arc<RwLock<Event>>> {
        span!("r20_event");
    ...
    pub fn r20_state<'a>(&'a self, store: &'a AssociativeRwlockStore) -> Vec<Arc<RwLock<State>>> {
        span!("r20_state");
