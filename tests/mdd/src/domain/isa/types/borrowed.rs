...
use crate::domain::isa::types::mutable::MUTABLE;
use crate::domain::isa::types::ownership::Ownership;
use crate::domain::isa::types::shared::SHARED;
...
impl Borrowed {
    ...
    pub fn r9_ownership<'a>(&'a self, store: &'a IsaStore) -> Vec<&Ownership> {
